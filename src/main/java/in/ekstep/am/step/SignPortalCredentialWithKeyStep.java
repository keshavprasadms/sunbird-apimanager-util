...
public class SignPortalCredentialWithKeyStep implements Step {
    ...
    SignPortalCredentialWithKeyStep(String userName, CredentialDetails responseBuilder, String key, KeyManager keyManager) {
    ...
    public void execute() throws Exception {
        ...
        KeyData keyData = keyManager.getRandomKey("portal");
